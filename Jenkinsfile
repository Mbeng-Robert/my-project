...
pipeline {
    ...
    stage('SonarQube Inspection') {
        steps {
            withSonarQubeEnv('SonarQube') { 
                ...
                sh """
                mvn sonar:sonar \
                -Dsonar.projectKey=jawa-webapp-project \
                -Dsonar.host.url=http://172.31.14.28:9000 \
  ...
  post {
    always {
        ...
        slackSend channel: '#rrpm-cicd-pipeline-alerts', //update and provide your channel name
